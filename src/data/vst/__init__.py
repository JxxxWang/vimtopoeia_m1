...
from src.data.vst.surge_xt_param_spec import SURGE_VIM_PARAM_SPEC

param_specs = {"surge_full": SURGE_XT_PARAM_SPEC, "surge_vim": SURGE_VIM_PARAM_SPEC, "surge_simple": SURGE_SIMPLE_PARAM_SPEC}
